...
std::string AYRIA::SMS4::Encrypt(std::string &Key, std::string &IV, std::string Plaintext)
{
...
std::string AYRIA::SMS4::Decrypt(std::string &Key, std::string &IV, std::string Ciphertext)
{
